...
<head>
    ...
    <meta name="description" content="Traveller-friendly business information and approved multilingual phrases from TravEase.">
    <title>Tourism business · TravEase</title>
    <link rel="stylesheet" href="assets/css/styles.css">
</head>
<body class="public-business">
    <header class="public-topbar">
        <a class="brand public-brand" href="index.php"><span class="brand-mark">T</span><span>TravEase<small>Travel with confidence</small></span></a>
        <a class="secondary" href="index.php">Open travel tools</a>
    </header>
    <main class="content-wrap public-wrap">
        <div id="publicStatus" class="card-panel public-loading"><span class="action-icon aqua">⌂</span><div><span class="eyebrow">TravEase business</span><h1>Loading business information…</h1><p>Please wait while we prepare the traveller page.</p></div></div>
        ...
        <footer>Powered by TravEase · Clearer travel communication in Malaysia</footer>
    </main>
...
async function load(){const r=await fetch('api/public_business.php?slug='+encodeURIComponent(slug));const d=await r.json();if(!r.ok){$('#publicStatus').innerHTML='<span class="action-icon coral">!</span><div><span class="eyebrow">TravEase business</span><h1>Business page unavailable</h1><p>'+esc(d.message)+'</p></div>';return;}$('#publicStatus').hidden=true;$('#publicBusiness').hidden=false;render(d);}
