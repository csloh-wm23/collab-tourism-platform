    ...
    <main class="main-area">
        <header class="topbar">
            ...
            <div class="top-actions">
                ...
                <?php if ($user): ?>
                    <button class="profile-chip profile-button" type="button" data-page="profile" aria-label="Open profile settings"><span><?= htmlspecialchars(mb_strtoupper(mb_substr($name, 0, 1))) ?></span><div><strong id="profileNameLabel"><?= htmlspecialchars($name) ?></strong><small><?= htmlspecialchars(ucfirst($role)) ?></small></div></button>
        ...
        <div class="content-wrap">
            ...
            <?php if ($role === 'admin' && $staff): ?>
            <section class="page" id="admin" data-title="Administration"><div class="page-heading"><div><span class="eyebrow">Platform operations</span><h1>Administration</h1><p>Review platform health and business access.</p></div></div><div class="stat-grid"><article><span class="stat-icon aqua">◎</span><strong id="adminUsers">—</strong><small>Active users</small></article><article><span class="stat-icon blue">⌂</span><strong id="adminBusinesses">—</strong><small>Approved businesses</small></article><article><span class="stat-icon gold">◷</span><strong id="adminPending">—</strong><small>Pending review</small></article><article><span class="stat-icon coral">文</span><strong id="adminTranslations">—</strong><small>Translations</small></article></div><article class="card-panel mt-large"><div class="card-title-row"><div><span class="eyebrow">Review queue</span><h2>Pending business registrations</h2></div></div><div id="pendingBusinesses"></div></article></section>
            <?php endif; ?>
